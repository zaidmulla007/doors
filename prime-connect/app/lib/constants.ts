export const navigationCategories = [
    {
        name: { en: "Doors", ar: "الأبواب", zh: "门业" },
        slug: "doors",
        items: [
    ...
    },
    {
        ...
        slug: "color-card",
        items: [
            { name: { en: "Color Card", ar: "بطاقة الألوان", zh: "色卡" }, slug: "color-card" },
        ]
    },
    {
        name: { en: "Doors Hardware & Accessories", ar: "أجهزة وملحقات الأبواب", zh: "门五金配件" },
        slug: "hardware-accessories",
        items: [
            { name: { en: "Door Handles", ar: "مقابض الأبواب", zh: "门把手" }, slug: "door-handles" },
            { name: { en: "Door Hinges", ar: "مفصلات الأبواب", zh: "门铰链" }, slug: "door-hinges" },
            { name: { en: "Doors with Smart Locks", ar: "أبواب بأقفال ذكية", zh: "智能锁门" }, slug: "doors-with-smart-locks" },
        ]
    },
    {
        name: { en: "Cabinet", ar: "الخزائن", zh: "橱柜" },
        slug: "cabinet",
        items: [
    ...
    },
    {
        ...
        slug: "wardrobe",
        items: [
            { name: { en: "Wardrobe", ar: "خزانة الملابس", zh: "衣柜" }, slug: "wardrobe" },
        ]
    },
    {
        name: { en: "Core Panel", ar: "اللوح الأساسي", zh: "核心板材" },
        slug: "core-panels",
        items: [
