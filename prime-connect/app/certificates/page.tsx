...
import { FileText, Award, X, ChevronLeft, ChevronRight } from "lucide-react";
...
export default function CertificatesPage() {
    ...
    const [currentPage, setCurrentPage] = useState(1); // 1 for front, 2 for back

    const certificates = [
        {
            id: 1,
            title: t('certificatesPage.cert1Title'),
            frontImage: "/certificate-images/1.pdf/1.png",
            backImage: "/certificate-images/1.pdf/2.png",
            description: t('certificatesPage.cert1Desc')
        },
        {
            id: 2,
            title: t('certificatesPage.cert2Title'),
            frontImage: "/certificate-images/2.pdf/1.png",
            backImage: "/certificate-images/2.pdf/2.png",
            description: t('certificatesPage.cert2Desc')
        },
        {
            id: 3,
            title: t('certificatesPage.cert3Title'),
            frontImage: "/certificate-images/3.pdf/1.png",
            backImage: "/certificate-images/3.pdf/2.png",
            description: t('certificatesPage.cert3Desc')
        },
        {
            id: 4,
            title: t('certificatesPage.cert4Title'),
                ...
                <div className="container-custom relative">
                    ...
                    >
                        ...
                        <motion.div variants={fadeInUp}>
                            <a href="#certificates-list" className="btn-primary">
                                {t('certificatesPage.viewCertificates')}
                    ...
                    >
                        {certificates.map((cert, index) => (
                            <motion.div
                                ...
                                className="group"
                                onClick={() => {
                                    setSelectedCert({ index, title: cert.title, description: cert.description });
                                    setCurrentPage(1);
                                }}
                            >
                                <div
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                >
                                    {/* Main Image */}
                                    <Image
                                        src={currentPage === 1 ? certificates[selectedCert.index].frontImage : certificates[selectedCert.index].backImage}
                                        alt={`${selectedCert.title} - Page ${currentPage}`}
                                        fill
                                ...
                                {showZoom && (
                                    <div className="hidden md:block absolute left-full top-0 ml-4 w-[400px] h-[400px] bg-white border-2 border-gray-200 rounded-xl shadow-2xl overflow-hidden z-50">
                                        <div
                                            ...
                                            style={{
                                                backgroundImage: `url(${currentPage === 1 ? certificates[selectedCert.index].frontImage : certificates[selectedCert.index].backImage})`,
                                                backgroundSize: '200%',
                ...
                <div className="container-custom">
                    ...
                    >
                        ...
                        <p className="text-gray-600 mb-8">
                            {t('certificatesPage.questionsDesc')}
                        </p>
                        <a
                            href="/contact"
