...
// Hero slides data - moved inside component to use translations
...
export default function HomePage() {
  ...
  const heroSlides = [
    { image: "/banner-images/1.png", alt: t('hero.alt1') },
    { image: "/banner-images/2.png", alt: t('hero.alt2') },
    { image: "/banner-images/3.png", alt: t('hero.alt3') },
    { image: "/banner-images/4.png", alt: t('hero.alt4') },
    { image: "/banner-images/5.png", alt: t('hero.alt5') },
  ];
  ...
  return (
    <>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex gap-3">
          {heroSlides.map((_, index) => (
            <button
              ...
              aria-label={`${t('hero.goToSlide')} ${t(`common.stat${index + 1}` as any)}`}
            />
          ))}
        </div>
      </section>
      ...
      <section className="section-padding bg-gradient-to-br from-blue-600 to-purple-600 text-white relative overflow-hidden">
        {/* Decorative pattern for the gradient background */}
        ...
        <div className="container-custom relative">
          ...
          >
            <motion.span variants={fadeInUp} className="text-white font-semibold mb-4 block">
              {t('products.sectionTitle')}
            </motion.span>
            <motion.h2 variants={fadeInUp} className="text-white mb-4">
              {t('products.headingStart')} <span className="text-white">{t('products.headingGradient')}</span>
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-white max-w-2xl mx-auto">
                ...
                <Link href={cat.id === 'wardrobe' ? `/product/${cat.slug}` : `/products?category=${cat.slug}`} className="flex flex-col h-full">
                  ...
                  <div className="relative overflow-hidden" style={{ height: '85%' }}>
                    ...
                    <div className="absolute top-6 left-6">
                      <div className="w-16 h-16 rounded-2xl bg-white/20 backdrop-blur-md flex items-center justify-center border-2 border-white/40 shadow-lg group-hover:scale-110 group-hover:bg-white/30 transition-all duration-300">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4">
                      <h3 className="text-xl font-bold text-white group-hover:translate-y-[-2px] transition-transform duration-300">
                  ...
                  <div className="px-4 py-3 bg-white flex items-center justify-between" style={{ height: '15%' }}>
                    <p className="text-gray-600 text-xs line-clamp-1 flex-1">
                      {t(`products.categories.${cat.id}.desc`)}
                    </p>
                    <span className="inline-flex items-center text-sm font-bold text-blue-600 group-hover:text-purple-600 group-hover:gap-2 gap-1.5 transition-all duration-300 ml-2">
                      {t('products.explore')}
                  ...
                  <div className="absolute inset-0 rounded-3xl border-2 border-transparent group-hover:border-blue-400/50 transition-all duration-500 pointer-events-none" />
                </Link>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <Link href="/categories" className="btn-secondary !border-white/30 !text-black hover:!bg-white/10">
              {t('products.viewAll')}
            </Link>
          </motion.div>
        </div>
      ...
      <section className="section-padding bg-gradient-to-br from-blue-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          >
            ...
            <motion.h2 variants={fadeInUp} className="text-white mb-4">
              {t('sectors.headingStart')} <span className="text-white">{t('sectors.headingGradient')}</span>
            </motion.h2>
            <motion.p variants={fadeInUp} className="text-white max-w-2xl mx-auto">
          ...
          >
            {sectors.map((sector, index) => (
              ...
              >
                ...
                <p className="text-white-400">{t(`sectors.items.${sector.id}.desc`)}</p>
              </motion.div>
            ))}
          </motion.div>
          ...
          >
            <Link href="/contact" className="btn-primary !bg-white !text-white-600 hover:!bg-white/90">
              {t('sectors.discussProject')}
              <ArrowRight className="w-5 h-5 rtl:rotate-180" />
            </Link>
            <Link href="/products" className="btn-secondary !border-white/30 !text-black hover:!bg-white/10">
