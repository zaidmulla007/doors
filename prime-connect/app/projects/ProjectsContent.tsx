                            ...
                            <AnimatePresence>
                                {isDropdownOpen && (
                                    ...
                                    >
                                        ...
                                        >
                                            <Video className="w-5 h-5" />
                                            <span className="font-medium">Project Videos</span>
                                        </button>
                                    </motion.div>
                                )}
                            </AnimatePresence>
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        ...
                                        >
                                            {/* Main Image */}
                                            <Image
                                                src={`/projects/images/${projectImages[selectedImage]}.png`}
                                                alt={`Project ${projectImages[selectedImage]}`}
                                                fill
                                    ...
                                    <div className="p-8 flex flex-col overflow-y-auto">
                                        <div className="flex justify-between items-start mb-6">
                                            <div>
                                                <h3 className="text-2xl font-bold text-gray-900">Project {projectImages[selectedImage]}</h3>
                                                <p className="text-sm text-gray-500 mt-1">
                                                    Completed Project by Prime Connect
                                                </p>
                                            </div>
                                            <button
                                                onClick={() => setSelectedImage(null)}
                                        ...
                                        <div className="mt-auto space-y-4">
                                            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-6 rounded-xl border-2 border-blue-100">
                                                <h4 className="font-bold text-gray-900 mb-2">Interested in a Similar Project?</h4>
                                                <p className="text-sm text-gray-600 mb-4">
                                                    Contact us to discuss your requirements and get a customized solution.
                                                </p>
                                                <Link
                                                    href="/contact"
                                                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all w-full justify-center"
                                                >
                                                    Contact Us
                                ...
                                >
                                    ...
                                    <div className="relative bg-black">
                                        <div className="relative h-64 md:h-[90vh] flex items-center justify-center">
                                            <video
                                                ref={videoRef}
                                                src={`/projects/videos/${projectVideos[selectedVideo]}.mp4`}
                                    ...
                                    <div className="p-8 flex flex-col overflow-y-auto">
                                        <div className="flex justify-between items-start mb-6">
                                            <div>
                                                <h3 className="text-2xl font-bold text-gray-900">Project Video {projectVideos[selectedVideo]}</h3>
                                                <p className="text-sm text-gray-500 mt-1">
                                                    Completed Project by Prime Connect
                                                </p>
                                            </div>
