...
export const translations = {
    en: {
        ...
        certificatesPage: {
            ...
            cert5Title: "Product Certification",
            cert5Desc: "Official product quality and standards certification",
            cert6Title: "ISO 9001:2015 Quality Management",
            cert6Desc: "International standard for quality management systems",
            cert7Title: "ISO 14001 Environmental Management",
            cert7Desc: "Environmental management system certification",
            cert8Title: "Fire Safety Compliance Certificate",
            cert8Desc: "Certification for fire safety standards compliance",
            cert9Title: "Regional Building Codes Compliance",
            cert9Desc: "Compliance with regional building codes and standards",
    ...
    ar: {
        ...
        aboutPage: {
            ...
            storyP1: "برايم كونيكت للتجارة العامة هي شركة متعددة الجنسيات تدمج الصناعة والتجارة تأسست في دبي، الإمارات العربية المتحدة. انخرطت الشركة بعمق في مشاريع الهندسة المعمارية والديكور لمدة 25 عامًا وتنتج وتبيع بشكل رئيسي: الأبواب الخشبية الداخلية، أبواب WPC، الخزائن، الأبواب الفولاذية الخارجية، الأبواب المقاومة للحريق وخطوط أنابيب البناء، إلخ. تمتلك الشركة حصة مسيطرة في ستة مصانع، وهي مصنع الأبواب في دبي، مصنع WPC في جيانغشي، الصين، مصنع الأبواب الخشبية في تشجيانغ، الصين، مصنع الخزائن في تشجيانغ، الصين، مصنع الأبواب الفولاذية في تشجيانغ، الصين، ومصنع الأبواب المقاومة للحريق في شنغهاي، الصين. تمتلك سلسلة إمداد إنتاج قوية وقدرات بحث وتطوير تكنولوجي. تشارك منتجاتها في مشاريع الديكور المعماري للعقارات التجارية والسكنية والمدارس والمستشفيات والمؤسسات الصناعية والتعدينية. يمكن استخدامها أيضًا للمشاريع المخصصة الخاصة مثل الشقق والفلل. نرحب بالأصدقاء من جميع أنحاء العالم لزيارة المصانع في دبي والصين ومناقشة التعاون وتحقيق وضع مربح للجانبين!",
            storyP2: "",
    ...
    zh: {
        ...
        aboutPage: {
            ...
            storyTitle: "我们的故事 &",
            storyHighlight: "传承",
            storyP1: "普莱姆连接综合贸易公司是一家集工贸一体的跨国公司，成立于阿拉伯联合酋长国迪拜。公司深耕建筑装饰工程项目25年，主要生产销售：室内木门、WPC门、橱柜、室外钢质入户门、防火门及建筑管道等。公司控股六家工厂，分别为迪拜门厂、中国江西WPC工厂、中国浙江木门厂、中国浙江橱柜厂、中国浙江入户门（钢质）工厂和中国上海防火门工厂。拥有强大的生产供应链和技术研发能力。其产品涉及商业和住宅房地产、学校、医院、工矿企业的建筑装饰项目，也可用于公寓、别墅等私人定制项目。欢迎世界各地的朋友来迪拜和中国的工厂参观，洽谈合作，实现双赢！",
            storyP2: "",
            yearsExp: "年经验",
            factories: "工厂",
            countries: "国家",
